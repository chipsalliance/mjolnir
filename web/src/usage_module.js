...
export function registerUsageModule(navContainer, routeHandlers, renderEmptyState) {
  ...
  routeHandlers["#/usage"] = async (viewport) => {
    viewport.innerHTML = `
